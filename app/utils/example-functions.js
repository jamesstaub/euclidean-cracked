export default function examples(name) {
  return {
    sequencerVariables: `
/**
...
// load this function, press play, then open your debug console to see these values update
...
if (index % 2) {
  ...
  __(this.lowpass).attr({frequency: 1200, q: 5});
    ...
    filterSweep: `
  /**
    Use the cracked library's __.scale() to convert the step index
